...
const credentials = {
  ...
  token_uri: process.env.FIREBASE_CREDENTIAL_TOKEN_URL,
  auth_provider_x509_cert_url: process.env.FIREBASE_CREDENTIAL_AUTH_PROVIDER_X509_CERT_URI,
  client_x509_cert_url: process.env.FIREBASE_CREDENTIAL_CLIENT_X509_CERT_URL,
  universe_domain: process.env.FIREBASE_CREDENTIAL_UNIVERSE_DOMAIN
};
